...
import { addCategory, handleAddPremiumPackage } from "../../services/api/adminApi";
...
const AddPackage: React.FC = () => {
  ...
  const pacakageData = location.state;
  ...
  const handleAdd = async (e: any) => {
    ...
    try {
      ...
      const res = await handleAddPremiumPackage(title, description,price || 0);
      if (res?.data.success) {
        setError("");
        setTitle("")
        setDescription("")
