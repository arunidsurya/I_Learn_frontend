...
const EditCourseInformation: React.FC<Props> = ({
  courseInfo,
  setCourseInfo,
  active,
  setActive,
  ...
  const handleChange = async (file: any, courseInfo: any) => {
    if (file) {
      ...
      setItemsToRemove([...itemsToRemove, courseInfo.thumbnail]);
      const response = await UploadS3Bucket(file);
      setCourseInfo({ ...courseInfo, thumbnail: response.url });
    }
  };
  ...
  const handleVideoChange = async (file: any, courseInfo: any) => {
        ...
        <div className="flex flex-col gap-2 h-1/2">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (file) {
                handleVideoChange(file, courseInfo);
              }
            }}
          />
          <div className="w-full mt-10">
            {courseInfo.demoUrl !== null && (
              <DemoPlayer
